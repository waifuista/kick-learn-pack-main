...
function SalesPage() {
  ...
  const inActionImages = [
    { src: "/assets/in-action-1.png", alt: "Child holding a completed World Cup superstar card on a football pitch." },
    { src: "/assets/in-action-2.png", alt: "Printable World Cup superstar worksheet with profile details and star ratings." },
    { src: "/assets/in-action-3.png", alt: "Boy showing his completed World Cup superstar card at home." },
    { src: "/assets/in-action-4.png", alt: "Goalkeeper-themed World Cup superstar worksheet ready to print." },
    { src: "/assets/in-action-5.png", alt: "Child proudly holding a completed football-themed printable worksheet at home." },
    { src: "/assets/in-action-6.png", alt: "Student showing a football maths worksheet in the classroom." },
    { src: "/assets/superstar-noah.png", alt: "Noah Harrison's completed My World Cup Superstar Card with 5-star Speed rating." },
    { src: "/assets/superstar-fairplay.png", alt: "Young player proudly showing his completed Fair Play Mission worksheet at football training." },
    { src: "/assets/superstar-ethan.png", alt: "Ethan Walker's World Cup Superstar Card completed in the classroom." },
  ];
  ...
  const actionCategories = [
    {
      ...
      items: [
        { src: "/assets/in-action-1.png", alt: "Child holding a completed World Cup superstar card on a football pitch.", caption: "Add your photo. Rate your skills. Become a World Cup superstar." },
        { src: "/assets/in-action-2.png", alt: "Printable World Cup superstar worksheet with profile details and star ratings.", caption: "A personalized football card kids will be excited to complete." },
        { src: "/assets/in-action-3.png", alt: "Boy showing his completed World Cup superstar card at home.", caption: "A special keepsake activity parents and teachers can proudly display." },
        { src: "/assets/in-action-4.png", alt: "Goalkeeper-themed World Cup superstar worksheet ready to print.", caption: "Fun profile pages that make every child feel part of the tournament." },
        { src: "/assets/in-action-5.png", alt: "Child proudly holding a completed football-themed printable worksheet at home.", caption: "Print, personalize and celebrate every child’s football identity." },
        { src: "/assets/in-action-6.png", alt: "Student showing a football maths worksheet in the classroom.", caption: "A memorable worksheet children will want to show again and again." },
        { src: "/assets/superstar-noah.png", alt: "Noah Harrison's completed My World Cup Superstar Card with 5-star Speed rating.", caption: "⚡ Meet Noah — 5-star Speed, Midfielder, and proud Manchester United superfan!" },
        { src: "/assets/superstar-fairplay.png", alt: "Young player proudly showing his completed Fair Play Mission worksheet at football training.", caption: "🤝 Fair Play Mission complete — real champions win with respect and teamwork!" },
        { src: "/assets/superstar-ethan.png", alt: "Ethan Walker's World Cup Superstar Card completed in the classroom.", caption: "⚽ Ethan the Forward dreams of scoring the winning goal — print yours today!" },
      ],
    },
    {
